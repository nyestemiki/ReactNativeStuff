...
import { SIZES, dummyData, COLORS, FONTS, icons, images } from '../../../constants/movieStreaming'
...
const Home = ({ navigation }) => {
	...
	const renderContinueWatchingSection = () => {
		return (
			...
			>
				...
				>
					<Text style={{ flex: 1, color: COLORS.white, ...FONTS.h2, fontWeight: 'bold' }}>
						Continue Watching
					</Text>
					<Image
	...
	return (
		<SafeAreaView
			style={{ flex: 1, backgroundColor: COLORS.black, paddingTop: SIZES.padding * 2 }}
		>
			{renderHeader()}
